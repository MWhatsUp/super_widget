...
class $TabView extends _SuperWidget {
  $TabView(List<Widget> views, {
    // DefaultTabController Widget properties
    int? length,
    int initialIndex = 0,
    Duration? animationDuration,

    // TabBarView Widget properties
    TabController? viewsTabController,
    ScrollPhysics? viewsScrollPhysics,
    DragStartBehavior viewsDragStartBehavior = DragStartBehavior.start,
    double viewportFraction = 1.0,
    Clip clipBehavior = Clip.hardEdge,

    // TabBar Widget properties
    required List<Widget> tabs,
    TabController? tapsTabController,
    bool tabsIsScrollable = false,
    ...
    DragStartBehavior tabsDragStartBehavior = DragStartBehavior.start,
    MouseCursor? mouseCursor,
    bool? enableFeedback,
    ValueChanged<int>? onTap,
    TabValueChanged<bool>? onHover,
    TabValueChanged<bool>? onFocusChange,
    ScrollPhysics? tabsScrollPhysics,
...
class $Tab extends _SuperWidget {
  $Tab({
...
class $DefaultTabController extends _SuperWidget {
  $DefaultTabController(Widget child, {
    // DefaultTabController Widget properties
    required int length,
    int initialIndex = 0,
    Duration? animationDuration,
...
class $TabBarView extends _SuperWidget {
  $TabBarView(List<Widget> children, {
    // TabBarView Widget properties
    TabController? viewsTabController,
    ScrollPhysics? viewsScrollPhysics,
    DragStartBehavior viewsDragStartBehavior = DragStartBehavior.start,
...
class $TabBar extends _SuperWidget {
  $TabBar(List<Widget> tabs, {
    // TabBar Widget properties
    TabController? tapsTabController,
    bool tabsIsScrollable = false,
    EdgeInsetsGeometry? tabsPadding,
